						...
						<ul>
							...
							<li class="has-dropdown">
								...
								<ul class="dropdown">
									...
									<li><a href="{{route('america')}}">America</a></li>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="feature-center animate-box" data-animate-effect="fadeIn">
							...
							<h3>Pick the package</h3>
							<p>you can choose anywhere we provided.</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="feature-center animate-box" data-animate-effect="fadeIn">
							...
							<h3>payment the selected one</h3>
					...
					<div class="col-md-4 col-sm-6">
						<div class="feature-center animate-box" data-animate-effect="fadeIn">
							...
							<h3> Choose a tour guide </h3>
							<p>That makes your tour easy.</p>
						</div>
					</div>
				...
				<div class="row row-p	b-md">
					...
					<div class="col-md-4">
						<div class="gtco-widget">
							<h3>About Us</h3>
							<p>we arrange many tours and travels that is world class you really needed.</p>
						</div>
					</div>
					...
					<div class="col-md-3 col-md-push-1">
						<div class="gtco-widget">
							...
							<ul class="gtco-quick-contact">
								<li><a href="#"><i class="icon-phone"></i> 01622947308</a></li>
